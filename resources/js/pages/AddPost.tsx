                ...
                >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div>
                            ...
                            <div
                                ...
                                ${!imagePreview ? 'border-white/20 hover:border-white' : 'border-transparent'}`}
                            ...
                            >
                                {imagePreview ? (
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <p className="text-sm text-white/60">Drag & drop an image here, or click to select</p>
                                        <p className="text-xs text-white/40">Supports: JPG, JPEG, PNG</p>
                                    </div>
                                )}
                                <input
                                    type="file"
                    ...
                    <div className="mt-8 flex justify-center">
                        <button
                            ...
                            className={`w-full max-w-xs py-3 rounded-xl transition-all flex items-center justify-center text-black hover:bg-gray-500 hover:text-white
                            ${isSubmitting ? 'cursor-not-allowed' : 'bg-gray-300 shadow-md hover:shadow-lg'}`}
                        >
                            {isSubmitting ? (
                                <>
